# -*- coding: utf-8 -*-
# Generated by Django 1.10.3 on 2016-11-14 05:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('video_type', models.CharField(choices=[('U', 'Url'), ('F', 'File')], default='F', max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='videos.VideoComment')),
